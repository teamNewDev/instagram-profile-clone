const Gallery = () => {
    return (
            ...
            <div class="gallery__section container">
                <div class="gallery__section__icons">
                    <div class="collage__icon current">
            ...
            <div class="gallery__section__imgs">
                <img src="Assets/imgs/finegirlsmile.jpg" class="img__single">
                <img src="Assets/imgs/itunes_wall.jpg" class="img__single">
                <img src="Assets/imgs/dance.jpg" class="img__single">
                <img src="Assets/imgs/finegirlsmile.jpg" class="img__single">
                <img src="Assets/imgs/itunes_wall.jpg" class="img__single">
            </div>
        </div>
