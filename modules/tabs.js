const Tabs = () =>{
    ...
    return `<div class="tabholder">
        <svg class="tablinks active" onclick="openTab(event, 'galleryTab')" fill="#8e8e8e" height="24" viewBox="0 0 48 48" width="24">
    ...
    <div class="tabholder">
        <svg class="tablinks" onclick="openTab(event, 'videoTab')" fill="#8e8e8e" height="24" viewBox="0 0 48 48" width="24">
    ...
    <div class="tabholder">
        <svg class="tablinks" onclick="openTab(event, 'channelTab')" fill="#8e8e8e" height="24" viewBox="0 0 48 48" width="24">
    ...
    <div class="tabholder">
        <svg class="tablinks" onclick="openTab(event, 'tagTab')" fill="#8e8e8e" height="24" viewBox="0 0 48 48" width="24">
